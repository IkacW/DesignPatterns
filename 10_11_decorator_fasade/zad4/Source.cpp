...
// Solution thath Fasace gives is that user does need to know all the necessary paramaters which
// our program needs for running script.
// So we are doing everything in a background without asking user for any values.
