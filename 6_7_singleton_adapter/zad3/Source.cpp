...
protected:
	// we want to allow calling these functions in inherited classes.
...
int main() {
	...
	//using references is allowing polymorphic behavior, so it will call use() from classDerivedSingleton1, 
	// although getInstance returns refrence of BaseSingleton
